...
import GHC.Char ( chr )  
import           GHC.Generics
data Bool =   True | False  deriving (Generic,            Show,             Lift,            Data, Typeable)
data Prod a b =    Pair a b
type TString =MyString
data MyString =   EmptyString | String Byte MyString  deriving ( Generic, Show,  Data, Typeable,           Lift           )
data Nat =  O  | S Nat  deriving ( Generic, Show,Lift,  Data, Typeable)
data N =   N0  | Npos Positive  deriving ( Generic, Show,Lift,             Data, Typeable)
data Positive =  XI Positive  | XO Positive  | XH  deriving ( Generic, Show,Lift,              Data, Typeable)
type Elt0 = UniversalLevel
data Comparison =   Eq | Lt | Gt  deriving ( Generic, Show,Lift,             Data, Typeable)
...
data Tree0 =   Leaf0 | Node0 T0 Tree0 (TProd_TProd_UniversalLevel_TNumRel_25S_UniversalLevel) Tree0  deriving ( Generic, Show, Lift,             Data, Typeable)
data T13 =   LSProp | LProp  deriving ( Generic, Show, Lift,             Data, Typeable)
...
data Modpath =   MPfile Dirpath | MPbound Dirpath Ident Nat | MPdot Modpath Ident deriving ( Generic, Show, Lift,            Data, Typeable)
type Kername = Prod Modpath Ident
type OKername = Option Kername
type TTree_syn_4 = TTree_26
data TNumRel_3 =   Le Z | Eq0  deriving ( Generic, Show, Lift,             Data, Typeable)
type TNumRel_syn_24 = TNumRel_3
type TTree_26 = Tree0
data Name =    NAnon | NNamed Ident          deriving ( Generic, Show, Lift,                     Data, Typeable)
data Relevance =   Relevant | Irrelevant  deriving ( Generic, Show, Lift,             Data, Typeable)
type Binder_annot  = BinderAnnot
data BinderAnnot a =   MkBindAnn a Relevance  deriving ( Generic, Show, Lift,             Data, Typeable)
type Aname = Binder_annot Name
type Cast_kind = CastKind
data CastKind =   VmCast | NativeCast | Cast  deriving ( Generic, Show, Lift,             Data, Typeable)
type Case_info = CaseInfo
data Inductive = MkInd Kername Nat  deriving ( Generic, Show, Lift,            Data, Typeable)
data CaseInfo =  Mk_case_info Inductive Nat Relevance  deriving ( Generic, Show, Lift,            Data, Typeable)
...
data Def term =    Mkdef Aname term term Nat  deriving ( Generic, Show, Lift,   Data, Typeable)
type Universes_decl = UniversesDecl
data UniversesDecl =   Monomorphic_ctx  deriving ( Generic, Show, Lift,    Data, Typeable)
data Projection =   MkProjection Inductive Nat Nat  deriving ( Generic, Show, Lift,             Data, Typeable)
type Mfixpoint term = List (Def term)
type T33 = UniversalLevels -- 33 is the magic number by the way
type TUniversalLevels_33 = List UniversalLevel 
type UniversalLevel = UniversalLevel
data UniversalLevel =    Lzero | Level MyString | Lvar Nat  deriving (    Generic    ,Show    , Lift    ,Data    ,Typeable    )
data Term =   TRel Nat | TVar Ident | TEvar Nat (List Term) | TSort TLevelProps_syn_23 | TCast Term Cast_kind Term  | TProd Aname Term Term | TLambda Aname Term Term | TLetIn Aname Term Term Term | TApp Term (List Term) | TConst Kername TUniversalLevels_33  | TInd Inductive TUniversalLevels_33 | TConstruct Inductive Nat TUniversalLevels_33  | TCase Case_info (Predicate Term) Term (List (Branch Term)) | TProj Projection Term | TFix (Mfixpoint Term) Nat  | TCoFix (Mfixpoint Term) Nat  | TInt Prelude.Int | TFloat Prelude.Float   deriving ( Generic, Show, Lift,             Data, Typeable)
data Constant_body =   Build_constant_body Term (Option Term) Universes_decl Relevance  deriving ( Generic, Show, Lift,             Data, Typeable)
data TVariance_36 =   Irrelevant0 | Covariant | Invariant  deriving ( Generic, Show, Lift,             Data, Typeable)
data Option a =   Some a | None  deriving (    Show,    Data, Typeable)
data Context_decl term =   Mkdecl Aname (Option term) term  deriving ( Generic, Show,         
             Data, Typeable)
...
data Constructor_body =   Build_constructor_body Ident Context (List Term) Term Nat deriving ( Generic, Show, Lift,            Data, Typeable)
...
data TLevelProps_2 =   LProp0 | LSProp0 | LType TNonEmptyLevelExprSet22 deriving ( Generic, Show, Lift,            Data, Typeable)
type TLevelProps_syn_23 = TLevelProps_2
data Allowed_eliminations =   IntoSProp | IntoPropSProp | IntoSetPropSProp | IntoAny deriving ( Generic, Show, Lift,            Data, Typeable)
data Projection_body =   Build_projection_body Ident Relevance Term deriving ( Generic, Show, Lift,            Data, Typeable)
data One_inductive_body =   Build_one_inductive_body Ident Context TLevelProps_syn_23 Term Allowed_eliminations  (List Constructor_body) (List Projection_body) Relevance deriving ( Generic, Show, Lift,            Data, Typeable)
data MutualInductiveBody =   Build_mutual_inductive_body Recursivity_kind Nat Context (List                                                            One_inductive_body)   Universes_decl (Option (List TVariance_36)) deriving ( Generic, Show, Lift,            Data, Typeable)
data Global_decl =    ConstantDecl Constant_body  | InductiveDecl Mutual_inductive_body deriving ( Generic, Show, Lift,            Data, Typeable)
data Z =   Z0 | Zpos Positive | Zneg Positive  deriving ( Generic, Show, Lift,             Data, Typeable)
data Tree =   Leaf | Node T0 Tree UniversalLevel Tree  deriving ( Generic, Show, Lift,           Data, Typeable)
type TTree_4 = Tree
type TTree_syn_0 = TTree_4
type TTree_syn2_10 = TTree_syn_0
type TGlobalDeclaration = Prod Kername Global_decl
type Global_declarations = List (TGlobalDeclaration)
type TTree_syn2_32 = TTree_syn_4
type TSquareProdTree_35 = Prod TTree_syn2_10 TTree_syn2_32
type BigMama = (Prod Global_env Term)
data TMk_retroknowledge_Kername_Kername_37 = Mk_retroknowledge OKername OKername  deriving ( Generic, Show, Lift,Data, Typeable)
data Global_env =  Mk_global_env TSquareProdTree_35 Global_declarations TMk_retroknowledge_Kername_Kername_37deriving ( Generic, Show, Lift, Data, Typeable)
data Branch term =Mk_branch (List Aname) term  deriving ( Generic, Show, Lift, Data, Typeable)
data Predicate term =   Mk_predicate TUniversalLevels_33 (List term) (List Aname) term  deriving (    Show,      Data, Typeable)
data List a =   Nil | Cons a (List a)            deriving (              Show,    Data, Typeable)



####functions after except byte at the end
...
-- deriveGTraversable ''TVariance_36 
-- deriveGTraversable ''TMk_retroknowledge_Kername_Kername_37 
-- deriveGTraversable ''UniversalLevel 
-- deriveGTraversable ''TNumRel_3 
-- deriveGTraversable ''Term 
-- deriveGTraversable ''TLevelProps_2   
...
deriving stock instance Generic (List UniversalLevel ) 
deriving stock instance Generic (List TVariance_36) 
deriving stock instance Generic (List Term) 
deriving stock instance Generic (Option (List TVariance_36)) 
...
deriving stock instance Generic (TProd_TProd_UniversalLevel_TNumRel_25S_UniversalLevel)
deriving stock instance Show (TProd_TProd_UniversalLevel_TNumRel_25S_UniversalLevel) 
...
deriving stock instance Generic TSquareProdTree_35
deriving stock instance Show TSquareProdTree_35
deriving stock instance Show TUniversalLevelExpressions_14
deriving stock instance Show TGlobalDeclaration
deriving stock instance Show TProd_UniversalLevel_TNumRel_25S
deriving stock instance Generic TUniversalLevelExpressions_14
deriving stock instance Generic TProd_UniversalLevel_TNumRel_25S
...
-- deriving stock instance Lift (List UniversalLevel ) 
-- deriving stock instance Lift (List TVariance_36) 
-- deriving stock instance Lift (List Term) 
-- deriving stock instance Lift (Option (List TVariance_36)) 
--deriving stock instance Lift Kername 
-- deriving stock instance Lift (Option Term) 
-- deriving stock instance Lift (Predicate Term)
-- deriving stock instance Lift (TProd_TProd_UniversalLevel_TNumRel_25S_UniversalLevel)
-- deriving stock instance Lift (Prod Global_env Bool) 
-- deriving stock instance Lift (Prod Global_env Term)
-- --deriving stock instance Lift Kername
-- deriving stock instance Lift TSquareProdTree_35
-- deriving stock instance Lift TGlobalDeclaration
-- deriving stock instance Lift TUniversalLevelExpressions_14
-- deriving stock instance Lift TProd_UniversalLevel_TNumRel_25S
...
deriving  instance Lift (List UniversalLevel ) 
deriving  instance Lift (List TVariance_36) 
deriving  instance Lift (List Term) 
deriving  instance Lift (Option (List TVariance_36)) 
...
--deriving  instance Lift (TProd_TProd_UniversalLevel_TNumRel_25S_UniversalLevel) 
...
--deriving  instance Lift  TSquareProdTree_35
--deriving  instance Lift (TUniversalLevelExpressions_14) 
--deriving  instance Lift TProd_UniversalLevel_TNumRel_25S 
deriving  instance Lift (List (TGlobalDeclaration))

compare30 :: (TProd_TProd_UniversalLevel_TNumRel_25S_UniversalLevel) -> (TProd_TProd_UniversalLevel_TNumRel_25S_UniversalLevel) -> Comparison
compare30 pat pat0 =
  case pat of {
   Pair p l2 ->
    case p of {
     Pair l1 t ->
      case pat0 of {
       Pair p0 l2' ->
        case p0 of {
         Pair l1' t' ->
          case compare_universal_levels_10 l1 l1' of {
           Eq -> case compare27 t t' of {
                  Eq -> compare_universal_levels_10 l2 l2';
                  x -> x};
           x -> x}}}}}
create0 :: TTree_26 -> (TProd_TProd_UniversalLevel_TNumRel_25S_UniversalLevel) -> TTree_26 -> Tree0
create0 l x r =
  Node0 (add2 (max1 (height0 l) (height0 r)) _1) l x r
assert_false0 :: TTree_26 -> (TProd_TProd_UniversalLevel_TNumRel_25S_UniversalLevel) -> TTree_26 -> Tree0
assert_false0 =
  create0
bal0 :: TTree_26 -> (TProd_TProd_UniversalLevel_TNumRel_25S_UniversalLevel) -> TTree_26 -> Tree0
bal0 l x r =
  let {hl = height0 l} in
  let {hr = height0 r} in
  case ltb0 (add2 hr _2) hl of {
   ...
   False ->
    case ltb0 (add2 hl _2) hr of {
      ...
      case r of {
       ...
       Node0 _ rl rx rr ->
        case leb1 (height0 rl) (height0 rr) of {
         True -> create0 (creaet0 l x rl) rx rr;
         False ->
          case rl of {
           Leaf0 -> assert_false0 l x r;
           Node0 _ rll rlx rlr ->
     ...
     False -> create0 l x r}}
add8 :: (TProd_TProd_UniversalLevel_TNumRel_25S_UniversalLevel) -> Tree0 -> Tree0
add8 x s =
  case s of {
...
add5 :: (TUniversalLevelExpressions_14) -> (List (TUniversalLevelExpressions_14)) -> List (TUniversalLevelExpressions_14)
add5 x s =
  case s of {
   Nil -> Cons x Nil;
   Cons y l ->
    case case x of {
          Pair l1 b1 ->
           case y of {
            Pair l2 b2 ->
             case compare_universal_levels_10 l1 l2 of {
              Eq -> my_compare b1 b2;
              x0 -> x0}}} of {
     Eq -> s;
     Lt -> Cons x s;
...
snd p =
  case p of {
   Pair _ y -> y}
from_kernel_repr :: (Prod UniversalLevel Bool) -> TUniversalLevelExpressions_14
from_kernel_repr e =
  Pair (fst e) (case snd e of {
                 True -> S O;
                 False -> O})
from_kernel_repr1 :: (Prod UniversalLevel Bool) -> (List (Prod UniversalLevel Bool)) -> TLevelProps_syn_23
...
--intance ToJSON (Prod (Global_declarations TMk_retroknowledge_Kername_Kername_37 Global_env) Bool) where
--  toEncoding = genericToEncoding defaultOptions
...
instance ToJSON OKername where
  toEncoding = genericToEncoding defaultOptions
instance ToJSON TMk_retroknowledge_Kername_Kername_37 where
  toEncoding = genericToEncoding defaultOptions
instance ToJSON TSquareProdTree_35 where
  toEncoding = genericToEncoding defaultOptions
instance ToJSON Tree where
  toEncoding = genericToEncoding defaultOptions
instance ToJSON TNumRel_3 where
  toEncoding = genericToEncoding defaultOptions
instance ToJSON TProd_UniversalLevel_TNumRel_25S where
  toEncoding = genericToEncoding defaultOptions
instance ToJSON TProd_TProd_UniversalLevel_TNumRel_25S_UniversalLevel where
  toEncoding = genericToEncoding defaultOptions
...
instance ToJSON Global_env where
  toEncoding = genericToEncoding defaultOptions
instance ToJSON UniversalLevel where
    toEncoding = genericToEncoding defaultOptions
...
instance ToJSON ListUniversalLevel where
    toEncoding = genericToEncoding defaultOptions
...
instance ToJSON CastKind  where 
  toEncoding = genericToEncoding defaultOptions
instance ToJSON TUniversalLevelExpressions_14 where
    toEncoding = genericToEncoding defaultOptions
...
instance ToJSON ListElt1 where
  toEncoding = genericToEncoding defaultOptions
instance  ToJSON TLevelProps_2 where 
  toEncoding = genericToEncoding defaultOptions
...
instance ToJSON UniversesDecl where
  toEncoding = genericToEncoding defaultOptions
instance ToJSON TVariance_36 where
  toEncoding = genericToEncoding defaultOptions
  
instance ToJSON ListTVariance_36 where
  toEncoding = genericToEncoding defaultOptions
  
instance ToJSON OptionListTVariance_36 where
  toEncoding = genericToEncoding defaultOptions
...
-- instance ToJSON (Global_declarations TMk_retroknowledge_Kername_Kername_37 Global_env)  where
--  toEncoding = genericToEncoding defaultOptions

--      • Expected kind ‘* -> * -> *’,
--        but ‘Global_declarations’ has kind ‘*’

--instance ToJSON (Prod (Global_declarations TMk_retroknowledge_Kername_Kername_37 Global_env) Bool) where
-- toEncoding = genericToEncoding defaultOptions
...
deriving  instance Data TProd_TProd_UniversalLevel_TNumRel_25S_UniversalLevel
deriving  instance Data TProd_UniversalLevel_TNumRel_25S
deriving  instance Data TSquareProdTree_35
deriving  instance Typeable Server.MetaCoq.TestMeta.BigMama
deriving  instance Data TGlobalDeclaration
--deriving  instance Data (Prod UniversalLevel Nat)
deriving  instance Data TUniversalLevelExpressions_14
...
add9 :: TProd_TProd_UniversalLevel_TNumRel_25S_UniversalLevel -> TTree_syn2_32 -> TTree_syn2_32
add9 x s =
  add8 x (this1 s)
lt :: T_3
lt =  Le (Zpos XH)
...
of_list0 :: (List Elt0) -> TTree_syn2_10
of_list0 l =
  fold_right add4 empty0 l

compare_universal_levels_10 :: UniversalLevel -> UniversalLevel -> Comparison
compare_universal_levels_10 l1 l2 =
  case l1 of {
   Lzero -> case l2 of {
             Lzero -> Eq;
             _ -> Lt};
...
compare27 :: TNumRel_syn_24 -> TNumRel_syn_24 -> Comparison
compare27 x y =
  case x of {
   Le n -> case y of {
            Le m -> compare2 n m;
...
add4 :: Elt0 -> TTree_syn2_10 -> TTree_syn2_10
add4 x s =
  add3 x (this s)
compare5 :: TString -> TString -> Comparison
compare5 =
  compare4
compare4 :: TString -> TString -> Comparison
compare4 xs ys =
  case xs of {
...
create :: TTree_4 -> UniversalLevel -> TTree_4 -> Tree

create l x r =
  Node (add2 (max1 (height l) (height r))
        _1       
       ) l x r
assert_false :: TTree_4 -> UniversalLevel -> TTree_4 -> Tree
assert_false =
  create
height :: TTree_4 -> T0
height s =
...
bal :: TTree_4 -> UniversalLevel -> TTree_4 -> Tree
bal l x r =
  let {hl = height l} in
  let {hr = height r} in
  case ltb0 (add2 hr _2) hl of {
...
--type Elt4 = Prod (Prod UniversalLevel TNumRel_syn_24) UniversalLevel
make2 :: UniversalLevel -> TNumRel_syn_24 -> UniversalLevel -> TProd_TProd_UniversalLevel_TNumRel_25S_UniversalLevel
make2 l1 ct l2 =
  Pair (Pair l1 ct) l2
...
--le0 = Le0
add_list :: (List TUniversalLevelExpressions_14) -> NonEmptyLevelExprSet -> NonEmptyLevelExprSet
add7 :: TUniversalLevelExpressions_14 -> NonEmptyLevelExprSet -> NonEmptyLevelExprSet
t_set :: NonEmptyLevelExprSet -> TListElt1_syn2_21
t_set n =
  n

add7 e u =
  add6 e (t_set u)
add6 :: Elt2 -> TListElt1_syn2_21 -> TListElt1_syn2_21
add6 x s =
  add5 x (this0 s)
this0 :: TListElt1_syn_1 -> TListElt1_18
this0 t =
  t
make1 :: TUniversalLevelExpressions_14 -> TNonEmptyLevelExprSet22
make1 =
  singleton3
...
--lt = Lt
-- empty4 = Empty4
empty4 :: TTree_syn2_32
empty4 =
  empty3

singleton3 :: TUniversalLevelExpressions_14 -> NonEmptyLevelExprSet
singleton3 =
  singleton2
singleton2 :: Elt2 -> TListElt1_syn2_21
singleton2 =
  singleton1
...
singleton1 x =
  Cons x Nil
make :: UniversalLevel -> TUniversalLevelExpressions_14
make l =
  Pair l O

make' :: UniversalLevel -> NonEmptyLevelExprSet
make' l =
  singleton3 (make l)

of_levels :: (Sum T13 UniversalLevel ) -> TLevelProps_syn_23
of_levels l =
  case l of {
   Inl t -> case t of {
             LSProp -> LSProp0;
...
-- type T34 = Prod (List Name) TTree_syn2_32
-- type TTree_syn2_32 = TTree_syn_4
-- type TSquareProdTree_35 = Prod TTree_syn2_10 TTree_syn2_32
